...
export const BottomTabNavigator = () => {
  return (
    <Tab.Navigator
      ...
      <Tab.Screen name="Tab2" options={{ title: "Tab2", tabBarIcon: ({ color }) => (<Text style={{color: color}}>"Tab2"</Text>) }} component={TopTabsNavigator} />
      {/* <Tab.Screen name="Tab3" options={{ title: "Tab3", tabBarIcon: ({ color }) => (<Text style={{color: color}}>"Tab3"</Text>) }} component={Tab3Screen} /> */}
      <Tab.Screen name="Tab3" options={{ title: "Tab3", tabBarIcon: ({ color }) => (<Text style={{color: color}}>"Tab3"</Text>) }} component={StackNavigator} />
    </Tab.Navigator>
  );
}